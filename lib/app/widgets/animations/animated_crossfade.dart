...
/// Signature for the [DPAnimatedCrossFade.layoutBuilder] callback.
///
...
/// [DPAnimatedCrossFade] is rebuilt with a different value for the
...
/// [DPAnimatedCrossFade] widget cross-fades between the two forms of the logo
/// over three seconds.
///
/// ```dart
/// AnimatedCrossFade(
...
///  * [AnimatedSize], the lower-level widget which [DPAnimatedCrossFade] uses to
///    automatically change size.
class DPAnimatedCrossFade extends StatefulWidget {
  ...
  final Widget Function() firstChildBuilder;

  /// The child that is visible when [crossFadeState] is
  /// [CrossFadeState.showSecond]. It fades in when transitioning
  /// [crossFadeState] from [CrossFadeState.showFirst] to
  /// [CrossFadeState.showSecond] and vice versa.
  final Widget Function() secondChildBuilder;
  ...
  /// A builder that positions the [firstChildBuilder] and [secondChildBuilder] widgets.
  ///
  /// The widget returned by this method is wrapped in an [AnimatedSize].
  ///
  /// By default, this uses [DPAnimatedCrossFade.defaultLayoutBuilder], which uses
  ...
  /// constraints. This works well when the [DPAnimatedCrossFade] is in a position
  ...
  /// [DPAnimatedCrossFade] is being forced to a particular size, then it can
  ...
  /// The default layout algorithm used by [DPAnimatedCrossFade].
  ///
  ...
  @override
  State<DPAnimatedCrossFade> createState() => _DPAnimatedCrossFadeState();
}

class _DPAnimatedCrossFadeState extends State<DPAnimatedCrossFade> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(DPAnimatedCrossFade oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    if (_controller.status == AnimationStatus.dismissed) {
      ...
      topAnimation = _firstAnimation;
      bottomKey = kSecondChildKey;
      bottomChild = widget.secondChildBuilder();
      bottomAnimation = _secondAnimation;
    }
