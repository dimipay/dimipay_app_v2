...
class TermsOfServicePage extends StatelessWidget {
  final String termsOfServiceText = '''
      ...
      9 "페이스사인"이라 함은 네이버클라우드(주)에서 제공하는 CLOVA FaceSign서비스로, CLOVA 얼굴 인식 기술을 기반으로 사용자를 식별(1:N)하는 Admin 도구가 포함된 얼굴 인식서비스를 의미합니다.
      10 이 약관에서 정의되지 않은 용어는 일반적인 거래 관행 및 관련 법령에 따릅니다.
      ...
      6 "페이스사인"을 이용한 결제가 1년 간 존재하지 않는 경우, "회사"는 "회원"의 "페이스사인" 정보를 파기할 수 있습니다. "회사"는 파기 7일 전 디미페이앱 푸시로 파기 예정을 통지합니다.
