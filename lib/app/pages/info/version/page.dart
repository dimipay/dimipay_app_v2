                            ...
                            Column(
                              ...
                              children: [
                                ...
                                DPGestureDetectorWithOpacityInteraction(
                                  ...
                                  child: Text(
                                    '서비스 이용약관',
                                    style: textTheme.paragraph1Underlined.copyWith(color: colorTheme.grayscale600),
                                  ),
                                ),
                                const SizedBox(height: 8),
                                DPGestureDetectorWithOpacityInteraction(
                                  onTap: () => launchUrl(Uri.parse('https://plip.kr/pcc/13202939-c7d0-42e2-bd1c-f5652c6876a7/privacy-policy')),
                                  child: Text(
                                    '개인정보처리방침',
                                    style: textTheme.paragraph1Underlined.copyWith(color: colorTheme.grayscale600),
                                  ),
